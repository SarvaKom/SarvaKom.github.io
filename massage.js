console.log("massage js!")

// var, but should use let + const to declare a variable
const myButton = document.querySelector("button");
let theMain = document.getElementById("theMassage");
let theP = document.querySelector("p")

// when user clicks button trigger medium function
myButton.addEventListener('click', medium);

function medium(){
    console.log("!")
    theMain.style.backgroundColor="black"
    theP.textContent="t h e    m e d i u m    i s    t h e"
}
